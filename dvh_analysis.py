...
def dicom_dvh_stats_single(directory=None, stats=None, structures=None, output='df', include_body=True,verbose=True,save_df=False):
...
def dicom_dvh_stats_multi(parent_directory=None, stats='prompt', structures=None,
                           ...
                           struct_labels=False, verbose=True,save_df=False):
    ...
    for sub_dir in sub_dirs:
        ...
        sub_dir_results = dicom_dvh_stats_single(directory=sub_dir, stats=stats, structures=structures, output='df',
                                           include_body=include_body, verbose=verbose,save_df=save_df)
